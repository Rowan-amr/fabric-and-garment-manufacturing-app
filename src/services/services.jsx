  ...
  return (
    <div className="services-container">
      ...
      <div className="process-steps">
        ...
        <p>
          <strong>Pattern Making:</strong> Patterns are made using CAD
          (Computer-Aided Design) software. These are templates for garment
          sizes, ensuring consistency across production.
        </p>
        <p>
          <strong>Marker Making:</strong> The marker is a layout for fabric
          cutting. Using CAD software, the most efficient layout is created to
          minimize waste, ensuring optimal fabric utilization.
        </p>
        <p>
